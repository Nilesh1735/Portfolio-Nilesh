...
const projects = [
  ...
  {
    title: "LumanGuide",
    description: "An enterprise Agentic RAG system built on a LangGraph state machine, designed to streamline engineering onboarding and knowledge management. Orchestrates dynamic document grading and query routing with strict AppSec measures (JWT RBAC, prompt injection guardrails). Powered by DeepSeek for rapid chat generation and MongoDB Atlas for persistent, isolated multi-tenant chat history.",
